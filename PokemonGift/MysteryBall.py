...
for poke in legendary:
    ...
    pool.append(f'                message="&bA &6{poke[1]} &bchallenges you!"')
    pool.append('            }')
    index += 1
...
for poke in ultra_rare:
    ...
    pool.append(f'                chance={poke[-1]}')
    pool.append(f'                reward="COMMAND:pokemonbattle %p% {poke[0]}"')
    pool.append(f'                message="&bA &5{poke[1]} &bchallenges you!"')
    pool.append('            }')
    index += 1
...
for poke in very_rare:
    ...
    pool.append(f'                chance={poke[-1]}')
    pool.append(f'                reward="COMMAND:pokemonbattle %p% {poke[0]}"')
    pool.append(f'                message="&bA &9{poke[1]} &bchallenges you!"')
    pool.append('            }')
    index += 1
...
for poke in rare:
    ...
    pool.append(f'                chance={poke[-1]}')
    pool.append(f'                reward="COMMAND:pokemonbattle %p% {poke[0]}"')
    pool.append(f'                message="&bA &2{poke[1]} &bchallenges you!"')
    pool.append('            }')
    index += 1
...
for poke in common:
    ...
    pool.append(f'                chance={poke[-1]}')
    pool.append(f'                reward="COMMAND:pokemonbattle %p% {poke[0]}"')
    pool.append(f'                message="&bA &7{poke[1]} &bchallenges you!"')
    pool.append('            }')
    index += 1
pool.append("        }")
